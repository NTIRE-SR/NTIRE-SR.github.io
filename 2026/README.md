# NTIRE 2026 — Single-Image Super-Resolution (×4) Challenge (Website)
...
1. Create a new GitHub repo, e.g. `ntire2026-x4-sr`.
...
- CodaBench competition: https://www.codabench.org/competitions/13516/
